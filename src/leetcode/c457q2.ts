...
function processQueries(c: number, connections: number[][], queries: number[][]): number[] {
    const uf = new UF(c);
    const online = Array(c).fill(true);
...
export function run() {
    console.log(processQueries(5, [[1, 2], [2, 3], [3, 4], [4, 5]], [[1, 3], [2, 1], [1, 1], [2, 2], [1, 2]])); // Output: [3, 2, 3]
    console.log(processQueries(3, [], [[1, 1], [2, 1], [1, 1]])); // Output: [1, -1]
}