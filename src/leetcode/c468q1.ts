...
export function run() {
    console.log(evenNumberBitwiseORs([1, 2, 3, 4, 5, 6])); // Output: 6
    console.log(evenNumberBitwiseORs([7, 9, 11])); // Output: 0
    console.log(evenNumberBitwiseORs([1, 8, 16])); // Output: 24
}